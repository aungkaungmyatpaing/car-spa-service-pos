<x-layout.main activeMenu="brands">
    ...
    <div class="container mx-auto px-10 mt-5">
        <div class="flex justify-center bg-white w-full rounded-md py-10 px-10">
            <div class="w-full">
                <h1 class="text-2xl text-gray-500 font-bold mb-4">Create Brand</h1>
                    ...
                    <div class="flex flex-row gap-6">
                        <div class="w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" placeholder="brand name" name="name" id="name" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="mb-5">
                                ...
                                <textarea name="description" placeholder="brand description" id="description" class="w-full p-2 border rounded-md text-sm h-40" value="{{ old('description') }}"></textarea>
                                @error('description')
                                    <p class="text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
