<x-layout.main activeMenu="users">
    ...
    <div class="container mx-auto px-10 mt-5">
        <div class="flex justify-center bg-white w-full rounded-md py-10 px-10">
            <div class="w-full">
                <h1 class="text-2xl text-gray-500 font-bold mb-4">Create User</h1>
                    ...
                    <div class="flex flex-row gap-6">
                        <div class="w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" placeholder="user name" name="name" id="name" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="mb-5">
                                ...
                                <input type="email" placeholder="email" name="email" id="email" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('email') }}">
                                @error('email')
                                    <p class="text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <div id="passwordWrapper" class="flex items-center border rounded-md">
                                    <input type="password" placeholder="password" name="password" id="password" class="w-full p-2 h-12 rounded-md text-sm">
                            ...
                            <div class="mb-5">
                                ...
                                <div id="passwordConfirmationWrapper" class="flex items-center border rounded-md">
                                    <input type="password" placeholder="confirm password" name="password_confirmation" id="password_confirmation" class="w-full p-2 h-12 rounded-md text-sm">
                                    <i id="togglePasswordConfirmation" class="fa-solid fa-eye text-gray-400 mx-1 cursor-pointer"></i>
                                </div>
