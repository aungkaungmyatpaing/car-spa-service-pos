<x-layout.main activeMenu="products">
    ...
    <div class="container mx-auto px-10 mt-5">
        <div class="flex justify-center bg-white w-full rounded-md py-10 px-10 mb-20">
            <div class="w-full">
                <h1 class="text-2xl text-gray-500 font-bold mb-4">Update Product</h1>
                    ...
                    <div class="flex flex-row gap-6">
                        <div class="w-1/2">
                            ...
                            <div class="mb-5">
                                ...
                                <input required type="text" placeholder="product name" name="name" id="name" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('name', $product->name) }}">
                                @error('name')
                            ...
                            <div class="mb-5">
                                ...
                                <textarea name="description" placeholder="product description" id="description" class="w-full p-2 border rounded-md text-sm h-40">{{ old('description', $product->description) }}</textarea>
                                @error('description')
                                    <p class="text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input required type="text" placeholder="product price" name="price" id="price" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('price', $product->price) }}">
                                @error('price')
                                    <p class="text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input required type="text" placeholder="product purchase price" name="purchase_price" id="purchase_price" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('purchase_price', $product->purchase_price) }}">
                            ...
                            <div class="mb-5">
                                ...
                                <input required type="number" placeholder="product stock" name="stock" id="stock" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('stock', $product->stock) }}">
                                @error('stock')
                                    <p class="text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input required type="number" placeholder="product stock alert limit" name="stock_limit" id="stock_limit" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('stock_limit', $product->stock_limit) }}">
                                @error('stock_limit')
                                    <p class="text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="w-1/2">
                            ...
                            <div class="mb-5">
                                ...
                                <input required type="text" placeholder="product design" name="design" id="design" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('design', $product->design) }}">
                                @error('design')
                                    <p class="text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input required type="text" placeholder="product model" name="model" id="model" class="w-full p-2 h-12 border rounded-md text-sm" value="{{ old('model', $product->model) }}">
                                @error('model')
                                    <p class="text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-5">
                                <label class="block mb-2 text-sm">Current Image</label>
                            ...
                            <div class="mb-5">
                                <label for="image" class="block mb-2 text-sm">Update Image</label>
