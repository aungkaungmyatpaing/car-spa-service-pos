<x-layout.main activeMenu="sizes">
    <div class="flex flex-row items-center justify-between px-10 mt-5">
        <h1 class="text-2xl text-gray-700 font-bold">Sizes</h1>
        <a href="{{route('sizes.create')}}" class="bg-blue-500 px-3 py-3 text-white rounded-md">
            Create Size
        </a>
    </div>
            ...
            <table class="w-full h-auto">
                ...
                <thead class="bg-[#f8f9fa]">
                    <tr>
                        ...
                        <th class="text-center font-semibold text-gray-500 px-7 py-4">Size</th>
                ...
                <tbody class="text-sm">
                    @foreach ($sizes as $index => $size)
                        <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-[#f8f9fa]' }} border border-b-1 border-gray-200">
                            ...
                            <td class="text-center text-gray-700 px-7 py-3">{{ $size->name }}</td>
